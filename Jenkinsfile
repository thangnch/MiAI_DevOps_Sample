pipeline{
    ...
    stages {
        ...
        stage ('Send to Nexus'){
            steps {
                nexusArtifactUploader artifacts: [[artifactId: 'main', classifier: '', format:'zip', file: 'main.zip', type: 'zip']], credentialsId: '948b1271-9a5c-4e21-bc0d-c8b27335d244', groupId: 'FlaskApp', nexusUrl: '192.168.1.144:8081',
